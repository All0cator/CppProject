...
{	
public:
	static enum Type { STATIC, DYNAMIC };
	static enum SubType { TILE, SPIKE, PLAYER, ENEMY };
...
public:
	...
	Box(float width_pixels, float height_pixels, float left_pixels, float top_pixels, Type type, SubType sub_type);
